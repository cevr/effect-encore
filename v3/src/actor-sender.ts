...
import { ActorMailboxLayer, type ActorMailboxShape } from "./actor-mailbox.js";
 ...
 * import { ActorSenderLayer } from "effect-encore/v3";
 *
...
const layerMemory: Layer.Layer<
  ActorMailboxShape | ActorAddressResolverShape | Snowflake.Generator | MessageStorage.MemoryDriver
> = layer.pipe(
